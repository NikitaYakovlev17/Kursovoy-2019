...
namespace MFST
{
	struct MfstState				// состояние автомата (для сохранения)
	{
		...
		short rulechainNo;			// номер текущего правила
		short ruleNo;				// номер текущей цепочки текущего правила
	...
	struct Mfst						// магазинный автомат
	{
		...
		{
			short nStep;							// количество шагов в выводе
			short* rulesNo;						// номера правил грамматики
			short* ruleChainsNo;					// номера цепочек правил грамматики (nrules)
			Deducation() { nStep = 0; rulesNo = 0; ruleChainsNo = 0; };
		} deducation;
