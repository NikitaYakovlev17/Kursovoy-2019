...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] = 
	{
		...
		ERROR_ENTRY(604, "|SA|: Ошибка в параметре вызываемой функции pow стандартной библиотеки"),
		...
		ERROR_ENTRY(705, "|SMA|: Ошибка в параметре вызываемой функции pow стандартной библиотеки"),
